 ...
 *
 */
public class GetParamReqt extends AbstractCommonMsg {
	...
	public void writeContent(ByteBuf buf) {
		buf.writeShort((short) CommandType.GET_PARAM_REQT.getType());
	}
	...
	public String toString() {
		return "GetParamReqt [version=" + HexUtils.appendPrefixHex(new byte[]{this.version}) 
