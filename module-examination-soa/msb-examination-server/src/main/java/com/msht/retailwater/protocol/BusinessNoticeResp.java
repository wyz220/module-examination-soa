 ...
 *
 */
public class BusinessNoticeResp extends AbstractCommonMsg {
	@Override
	public void writeContent(ByteBuf buf) {
		buf.writeShort((short) CommandType.BUSINESS_NOTICE_RESP.getType());
	}
	...
	public String toString() {
		return "BusinessNoticeResp [version=" + HexUtils.appendPrefixHex(new byte[]{this.version}) 
