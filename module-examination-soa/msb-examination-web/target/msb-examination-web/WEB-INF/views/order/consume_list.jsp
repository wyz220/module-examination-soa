      ...
      <jsp:include page="../common/menu.jsp"></jsp:include>
       <div id="main_content">
          <div class="main_title">
              <h3>普通订单</h3>
              <div class="pright">
              <shiro:hasPermission name="consume:export">
          ...
          <div class="main_filter">
            <div class="form">
              <form action="">
                ...
                <div class="fg">
                  <input type="text" class="text" placeholder="用户账号" id="account" name="account" maxlength="30" value="${param.account }">
                </div>
                <div class="fg">
                ...
                <div class="fg">
                  <input type="text" class="text" placeholder="小区名称" id="communityName" name="communityName" maxlength="100" value="${param.communityName }">
                </div>
                <div class="fg">
            ...
            <table class="table1">
              ...
              <tr>
               ...
               <c:forEach var="map" items="${ orderSourceMap }" varStatus="status">
                ...
                <td>${order.account }</td>
                <td>${order.amount }</td>
                <td>${order.saleWaterQuantity }</td>
                <td>${order.equipmentNo }</td>
                <td title="${order.equipAddress }"><c:out value="${order.equipAddress }"></c:out> </td>
                <td><c:out value="${order.equipCommunityName }"></c:out></td>
                <td>
                ...
                <td>
                <shiro:hasPermission name="consume:refund">
                <a href="javascript:;" class="btn" onclick="refund(${order.id})">退款</a>
                </shiro:hasPermission>
                </td>
              </tr>
              </c:forEach>
